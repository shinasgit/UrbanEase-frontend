  ...
  <main className="ml-64 mt-20 p-6 bg-gray-100 min-h-screen">
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <p className="text-sm text-gray-500">House Bookings</p>
          <h2 className="text-2xl font-bold mt-2">320</h2>
        </div>

        <div className="bg-white rounded-xl shadow p-6">
          <p className="text-sm text-gray-500">Appliance Bookings</p>
          <h2 className="text-2xl font-bold mt-2">23</h2>
        </div>

        {/* <div className="bg-white rounded-xl shadow p-6">
          <p className="text-sm text-gray-500">Settings</p>
          <h2 className="text-2xl font-bold mt-2">Manage</h2>
        </div> */}
      </div>
